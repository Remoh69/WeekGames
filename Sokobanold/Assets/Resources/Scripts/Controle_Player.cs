...
public class Controle_Player : MonoBehaviour {
	...
	public void Shoot(){
		...
		m_tabToucheSave[0] = m_tabTouche[0];
		m_tabToucheSave[1] = m_tabTouche[1];
		m_tabToucheSave[2] = m_tabTouche[2];
		m_tabToucheSave[3] = m_tabTouche[3];
		...
		StartCoroutine(Fin_Shoot());
		
	}

	public IEnumerator Fin_Shoot(){

		yield return new WaitForSeconds(1.0f);

		/*if (Input.GetKey (KeyCode.UpArrow) || Input.GetKey (KeyCode.DownArrow) || Input.GetKey (KeyCode.LeftArrow) || Input.GetKey (KeyCode.RightArrow)) {

			m_tabTouche[0] = m_tabToucheSave[0];
			m_tabTouche[1] = m_tabToucheSave[1];
			m_tabTouche[2] = m_tabToucheSave[2];
			m_tabTouche[3] = m_tabToucheSave[3];
